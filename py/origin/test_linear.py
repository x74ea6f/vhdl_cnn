...
##-- int8
x_pre = pd.read_csv("x_pre.csv", header=None).to_numpy()
w = pd.read_csv("fc1_w.csv", header=None).to_numpy()
b = pd.read_csv("fc1_b.csv", header=None).to_numpy()
exp = pd.read_csv("x_fc1_out.csv", header=None).to_numpy()
